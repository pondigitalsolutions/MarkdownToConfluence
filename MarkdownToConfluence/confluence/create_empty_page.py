...
def create_empty_page(page_name: str):
    if (confluence_utils.page_exists_in_space(confluence_utils.get_page_id(page_name, SPACEKEY), SPACEKEY)):
    ...
    if (response.status_code == 200):
        ...
        print(
            f"Error occured while attampting to create empty page, {page_name} at root of space. Status code: {response.status_code}")
    return response
